...
function GunFire:cursorInit(mode)
	...
	if self.cursorType == 0 then
		...
		self.cursorDir0 = config.getParameter("cursorDir0", "/cursors-azc/azdefault.cursor")
	...
	if self.cursorType == 1 then
		...
		self.cursorDir1 = config.getParameter("cursorDir1", "/cursors-azc/anim/100/azreticle100.png")
	...
	if self.cursorType == 2 then
		activeItem.setScriptedAnimationParameter("doAnim", false)
		self.cursorDir2 = config.getParameter("cursorDir2", "/cursors-azc/100/azreticle")
	end
end
